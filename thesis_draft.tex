...
\sffamily
	...
	Measuring the DC resistance of the IDE would be expected to show infinite resistance, as the glass substrate is a poor conductor and the IDE is a weak capacitor.
	Although the sample resistance (a parallel resistance) is typically high for the sample under test, this resistance changes when the sample is heated and the polymers are burned off.  The parallel resistance may drop to under 100 ohms during the burn-off of the polymers, which requires a four-point measurement to compensate for the series resistance test lead impedance.
